...
public class HomeController extends Controller {
    ...
    public Result addProductSubmit() {
        ...
        if (newProductForm.hasErrors()) {
            ...
            if (newProduct.getId() == null) {
                //Save the object to the Products table in the DB
                newProduct.save();

                //Get category ids (check boxes from form)
                //Find category objects and set categories list for the part
                for (Long cat : newProduct.getCatSelect()) {
                    newProduct.category.add(Category.find.byId(cat));
                }
                newProduct.update();
    ...
    public Result updateProductSubmit(Long id) {
                ...
                if (updateProductForm.hasErrors()) {
                    ...
                    //Get category ids(checked from form)
